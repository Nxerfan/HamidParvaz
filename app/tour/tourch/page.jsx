      ...
      <div className="container26">
        <div className="right">
          ...
          <div className="ItinerarySection">
            <h4>
              {PAGE_DATA.texts.itineraryTitle} (
              {PAGE_DATA.itineraryData.duration})
            </h4>
            <div className="Card ItineraryCard">
              {PAGE_DATA.itineraryData.days.map((day, index) => (
          ...
          <div className="Rooms">
            ...
            {PAGE_DATA.hotelInfoData.map((hotel, index) => (
              <div className="Card HotelListItem" key={index}>
                <div className="Top">
                  <div className="Title">
                    <p>
                      {hotel.title}{" "}
                      <FontAwesomeIcon icon={PAGE_DATA.starIcon} />{" "}
                      {hotel.rating}
                    </p>
                  </div>
                </div>
                    ...
                    {hotel.options.map((option, i) => (
                      <div className="Option" key={i}>
                        <FontAwesomeIcon
                          icon={
                            i === 0
                              ? PAGE_DATA.locationIcon
                              : PAGE_DATA.utensilsIcon
                          }
                        />{" "}
                        {option}
                      </div>
          ...
          <div className="Rules">
            ...
            <div className="Card">
              <div className="Time">
                <div className="Value">
                  <p>{PAGE_DATA.texts.durationLabel}</p>
                  <span>
                    {PAGE_DATA.hotelRules.checkIn}
                    <FontAwesomeIcon icon={PAGE_DATA.clockIcon} />
                  </span>
                </div>
                <div className="Value">
                  <p>{PAGE_DATA.texts.flightTypeLabel}</p>
                  <span>
        ...
        <div className="left">
          <div className="Card">
            <div className="rating">
              <div className="Stars">
                <div className="Wth">
                  {PAGE_DATA.tourData.badges.map((badge, i) => (
                    <span
                      key={i}
                      className={`Badge ${
              ...
              <p>{PAGE_DATA.tourData.title}</p>
              <div className="titel">
                <p>{PAGE_DATA.tourData.priceLabel}</p>
                <p>
                  <span>{PAGE_DATA.tourData.price.toLocaleString()}</span> تومان
                </p>
              </div>
            </div>
            ...
            <div className="price">
              <div className="text">
                <FontAwesomeIcon icon={PAGE_DATA.departureIcon} />
                <p>
                  {PAGE_DATA.texts.departureFlight}:{" "}
                  {PAGE_DATA.tourData.flights.departure}
                </p>
              </div>
              <div className="text">
                <FontAwesomeIcon icon={PAGE_DATA.arrivalIcon} />
                <p>
                  {PAGE_DATA.texts.returnFlight}:{" "}
                  {PAGE_DATA.tourData.flights.return}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="Card LeftFilterCard">
            <div className="filters" ref={calendarRef}>
              <p>{PAGE_DATA.texts.departureLabel}</p>
              <input
                type="text"
                id="startDateInput"
              ...
              />
              <p>{PAGE_DATA.texts.returnLabel}</p>
              <input
                type="text"
                id="endDateInput"
            ...
            <div className="PassengerFilter">
              <p>{PAGE_DATA.texts.passengerLabel}</p>
              <div className="PassengerControl">
                <div className="ControlGroup">
                  <label>{PAGE_DATA.texts.adultLabel}</label>
                ...
                <div className="ControlGroup">
                  <label>{PAGE_DATA.texts.childLabel}</label>
                  <div className="Counter">
                    <button
                      className="Minus"
                ...
                <div className="ControlGroup">
                  <label>{PAGE_DATA.texts.infantLabel}</label>
                  <div className="Counter">
                    <button
                      className="Minus"
