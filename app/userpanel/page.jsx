...
export default function ProfileManagement() {
  ...
  const openCalendar = useCallback(
    ...
    [passportExpiryDate, jToday, stringToJDate],
  );
            ...
            <form ref={formRef} onChange={calculateProgress} id="ProfileForm">
              ...
              <div className="Grid2">
                ...
                <div className="Field">
                  ...
                  <div className="Grid3">
                    {PAGE_DATA.birthDate.options.map((opt, i) => (
                      <select key={i}>
                        <option>{opt}</option>
                      </select>
                    ))}
                      ...
                      {showCalendar && (
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {currentView === "days"
                                ? `${currentJy} ${PAGE_DATA.calendar.monthNames[currentJm - 1]}`
                                : currentView === "months"
                          ...
                          {currentView === "months" && (
                            <div className="calendarView active">
                              <div className="monthsGrid">
                                {PAGE_DATA.calendar.monthNames.map(
                                  (name, idx) => (
                                    <div
                                      key={idx}
                                      className={`monthItem ${
