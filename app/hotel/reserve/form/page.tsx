...
const PAGE_DATA = {
  ...
  hotelCard: {
    image: ".bryan-goff-IuyhXAia8EA-unsplash.jpg",
    alt: "هتل",
    name: "هتل دزد نان",
    checkIn: {
      time: "14:00",
...
const NiksaPassengerInfo = () => {
  ...
  const handleSubmitAndSave = () => {
    ...
    params.set('hotelName', PAGE_DATA.hotelCard.name);
    params.set('startDate', PAGE_DATA.hotelCard.checkIn.label);
    params.set('endDate', PAGE_DATA.hotelCard.checkOut.label);
    const hotelPrice = 4000000;
    params.set('price', hotelPrice.toString());
    router.push(`/hotel/reserve/prepay?${params.toString()}`);
  };
          ...
          {passengers.map((passenger, index) => {
            const months =
              passenger.nationality === "foreign"
                ...
                : PAGE_DATA.passengerCard.shamsiMonths;
            ...
            <div className={`invoiceBody ${isInvoiceExpanded ? "open" : ""}`}>
              <div className="invoiceBodyInner">
                ...
                <div className="invoiceRow">
                  ...
                  <span className="invoiceRowValue">1 شب</span>
                </div>
