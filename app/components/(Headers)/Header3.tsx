      ...
      <div className="HeaderTop">
        <div className="Container">
          <Link href="/" className="Logo">
              <Image src="/logo.webp" alt="لوگوی سایت" width={200} height={75} />
          </Link>

          <nav>
            <div className="NavItem">
              <Image src="/traveler-خدمات مسافرتی.svg" alt="" width={20} height={20} role="presentation" /> خدمات مسافرتی <span className="Arrow" aria-hidden="true">▾</span>
            ...
            <div className="NavItem">
              <Image src="/user_groups-درباره ما.svg" alt="" width={20} height={20} role="presentation" /> درباره ما <span className="Arrow" aria-hidden="true">▾</span>
              <div className="Dropdown">
            ...
            <div className="NavItem">
              <Image src="/hotline-پشتیبانی.svg" alt="" width={20} height={20} role="presentation" /> پشتیبانی <span className="Arrow" aria-hidden="true">▾</span>
              <div className="Dropdown">
            ...
            <Link href="/blog" className="NavItem"><Image src="/blogloving-وبلاگ.svg" alt="" width={20} height={20} role="presentation" /> بلاگ</Link>
