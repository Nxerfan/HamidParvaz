...
const PAGE_DATA = {
  ...
  mainContent: {
    header: {
      icon: faPlane,
      text: "پرواز برگشت خود را انتخاب کنید",
    },
    sorting: {
      baseText: "پرواز برگشت و برگشت مشهد به تهران",
                ...
                <div className="LeftCard">
                  <div className="Bottom">
                    ...
                    <Link href="/MakeYourTour(4)" passHref>
                      <button className="BtnPrimary">انتخاب بلیط برگشت</button>
                    </Link>
                  </div>
                </div>
