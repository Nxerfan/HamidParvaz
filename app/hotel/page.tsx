...
import HotelDetailModal, { HotelDetail } from "../components/HotelDetailModal";
      ...
      cards: [
        {
          ...
          location: "مشهد",
          image:
            "https://www.eghamat24.com/blog/wp-content/webp-express/webp-images/doc-root/blog/wp-content/uploads/2019/07/Atlantis-Bahamas-Nassau.jpg.webp",
        },
        {
          id: 21,
          title: "هتل قصر طلایی",
      ...
      cards: [
        {
          ...
          location: "تهران",
          image:
            "https://www.eghamat24.com/blog/wp-content/webp-express/webp-images/doc-root/blog/wp-content/uploads/2019/07/Burj-Al-Arab-Dubai.jpg.webp",
        },
        {
          id: 41,
          title: "هتل لاله",
...
// تبدیل HotelCardType به HotelDetail برای modal
function cardToDetail(card: HotelCardType): HotelDetail {
  const priceNum = parseInt(card.price.replace(/[^\d]/g, ""), 10) || 0;
  const ratingNum = parseFloat(card.rate.split("/")[0]) || 0;
  return {
    id: card.id,
    name: card.title,
    image: card.image,
