...
const NiksaChooseOpt = () => {
  ...
  const toggleAllFlights = (checked: boolean) => {
    if (checked) {
  ...
  const toggleAllTimes = (checked: boolean) => {
    if (checked) {
                  ...
                  <div className="Opt">
                    ...
                    <div className="L">
                      <input
                        ...
                        ref={allFlightsRef}
                        onChange={(e) => toggleAllFlights(e.target.checked)}
                      />
                    </div>
                  </div>
                  ...
                  <div className="Opt">
                    ...
                    <div className="L">
                      <input
                        ...
                        id="AllCheckedTime"
                        ref={allTimesRef}
                        onChange={(e) => toggleAllTimes(e.target.checked)}
                      />
                    </div>
                  </div>

                  {/* لیست زمان‌ها با map و FontAwesomeIcon */}
